...
*(Archived - Character Recognition Model, **part of larger [Lipi-Snap](https://github.com/anisharyal0/Lipi-Snap) project** yoooooooooo)*
...
- **Dual Script Output** — Displays both predicted Ranjana Transcription and Devanagari Transliteration side-by-side.
- **Dynamic Font & Ranjana Unicode (U+11400) Support** — Switch between Normal and Stylish Ranjana display fonts (dynamically injected via base64) while maintaining copy-pasteable Ranjana Unicode under the hood via CSS overlay idea.
